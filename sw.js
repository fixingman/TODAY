...
const CACHE_VERSION  = 'today-v2.71.30';
...
self.addEventListener('fetch', event => {
  ...
  if (BYPASS_ORIGINS.some(origin => url.hostname === origin || url.hostname.endsWith('.' + origin))) return;
