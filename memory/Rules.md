...
- **Working on:** v2.48.4 — Trello 🍅 sessions now persist across days (BUG-068, `today_trello_focus_total`). Focus ask button overhauled (v2.48.3). Memory panel + Sunday/Monday enrichment shipped v2.48.1–2.48.2. Unverified: BUG-061 (Sunday/habit badges fresh device), BUG-067 (scroll position after focus, v2.44.1 awaiting real-device verify), ✦ question quality (Backlog Watching).
