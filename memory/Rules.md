...
- **Recent (2026-09-01):** v2.79.2 adds four reviewed commitment-imprint selections: a traditional Asante talking-drum verse recorded by R. S. Rattray, Olive Schreiner's choice from 'Life's Gifts', Ricardo Jaimes Freyre's pursuit image translated by Alice Stone Blackwell, and Kahlil Gibran's complete 'The Fox'. The corpus is 123; new candidates remain capped at 6 displayed lines and must still carry enough setup to stand alone.
