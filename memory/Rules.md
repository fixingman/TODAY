...
- **Watch for:** BUG-056 ⏳ blank after long Mac sleep (repaint to 5000ms — v2.31.9), awaiting verify · BUG-050 ⏳ sticky section headers — fourth pass v2.32.1 (scroll-driven animation, iOS 26+), awaiting real-device verify · BUG-041 ⏳ iOS PWA splash — third pass v2.32.1 (column pin), awaiting real-device verify · v2.28.0 ⏳ meeting mode mobile — awaiting real-device verify on iPhone PWA · v2.32.2 ⏳ safe-area bottom (CTAs above home indicator) — verify on iPhone · v2.32.3 ⏳ nudge verbatim task quotes — watch tomorrow's nudge reads naturally · v2.33.0 ⏳ Today block in About — W3 due 2026-08-01 · v2.32.0 meeting auto-select — verify `mine` attribution quality in real meetings · Partial-focus un-aging (BUG-043 design) — watching whether the partial-un-age rule feels wrong in practice
