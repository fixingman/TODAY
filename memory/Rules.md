...
- **Working on:** v2.32.0 — meeting review auto-selects user tasks (`item.mine`); v2.31.x polish/fix series (splash poem contrast, brief simplified to nudge+poem, BUG-056 repaint, BUG-050 iOS safe area, inline name capture)
...
- **Watch for:** BUG-056 ⏳ blank after long Mac sleep (repaint to 5000ms — v2.31.9), awaiting verify · BUG-055 ⏳ done tasks wiped on second-device open (v2.30.1), awaiting verify · BUG-050 ⏳ sticky section headers — iOS safe area fix v2.31.6, awaiting real-device verify · BUG-041 ⏳ iOS PWA splash white flash — fix v2.27.0, awaiting real-device verify · v2.28.0 ⏳ meeting mode mobile — awaiting real-device verify on iPhone PWA · BUG-032 ✅ verified 2026-07-08 · BUG-047 ✅ verified 2026-07-08 · BUG-054 ✅ verified 2026-07-11 · v2.32.0 meeting auto-select — verify `mine` attribution quality in real meetings · Partial-focus un-aging (BUG-043 design) — watching whether the partial-un-age rule feels wrong in practice
