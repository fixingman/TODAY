...
- **Working on:** v2.49.1 — TODAY logo now opens Memory panel; ✦ star button removed from input bar. v2.48.4: Trello 🍅 sessions persist across days (BUG-068). Unverified: BUG-061 (Sunday/habit badges fresh device). Watching: ✦ question quality (Backlog).
