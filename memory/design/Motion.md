...
### Triage Bar → Sheet Morph (v2.90.42, fixed v2.90.45, v2.90.48)
...
- Opening: `#triagePanel.triage-morph-opening` runs `triageMorphUp` (`--dur-slow`, `--ease-out`); the backdrop fades in on the same beat. Buttons and list stay hidden (`.triage-morph-active`) until 200ms, then fade in over 130ms.
