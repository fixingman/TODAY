...
**Seasons:** W9 / Sp13 / Su11 / Au10 / year-round 45, corpus 87, target ~90 (3 remaining).
...
**Leads:** Chamberlain 1902 scan (archive.org) — ~100 haiku, productive; Teasdale 'February Twilight' (*Dark of the Moon* 1926 — needs verified source scan). Closed: London Snow (too long), Turkish/Sufi (no worldwide-PD English, brief-fit failures).
