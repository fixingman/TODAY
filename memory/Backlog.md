...
| Unified day nudge (#dayNudge — one line instead of two) | v2.19.0 | 2026-07-19 | Does one line surface the right thing each morning? Does it feel less cluttered? Watch whether the rule-based fallback (carried-over + overdue) covers the common cases or if the AI sentence is needed. |
