...
| Poem splash coda + clean-slate echo | v2.26.0 | 2026-07-28 | **Pre-reg (2026-07-21):** coda is earning its place — sometimes goes to About specifically to finish reading the poem (second-home behaviour confirmed). Tension: splash timing feels tight on longer poems; fixed duration doesn't scale with length. Not click-to-dismiss — the auto-advance feels right. **Likely verdict:** kept + iterated — word-count-aware splash duration (more breath for longer poems) so About re-read is recovery not necessity. |
