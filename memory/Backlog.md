...
**Candidate moments:** ~~Sunday weekly recap~~ ✅ · ~~Monday intention prompt~~ ✅ · Daily contextual hint (insight-gated) covered by Today block nudge · ~~Learned patterns~~ ✅ → shipped v2.35.0 as Noticed block
...
**Shipped — all candidate moments complete:** Today block (v2.33.0, W3 ✅ 2026-07-31) · ✦ brief (v2.29.0, W3 ❌ removed v2.40.9) · Noticed block (v2.35.0–v2.39.0, W3 ✅ 2026-08-03) · Memory panel (v2.47.0–v2.48.2) — confirmed inferences injected into `_memoryForAI()`, personalises every AI surface · Sunday recap + Monday intention (v2.48.2) — enriched with `_memoryForAI('weekly')` context.
**Item 7 is feature-complete as of v2.48.2.** Remaining work is observation, not build — see Watching table.
...
| Sunday recap + Monday intention (memory-enriched) | v2.48.2 | 2026-08-17 | Open — enriched with `_memoryForAI('weekly')` context. Does the Monday line name something specific to how you work, or does it still feel generic? Quality will improve as confirmed memory inferences accumulate. Watch over 2–3 Sunday/Monday appearances. |
| Memory panel quality gate | v2.47.0 | 2026-09-01 | Open — after ~4 weeks of daily abstraction, are AI-generated hypotheses earning confirmation or getting dismissed? High dismiss rate = prompting or data quality problem, fix before building more surfaces on top. |
