...
| **Daily poem corpus growth** | Round 2 shipped (v2.17.80) | Grow `assets/poems.js` (31 after round 2, seasons balanced) toward ~90 via curation rounds in chat: Claude proposes ~15–20 verified public-domain poems, Can accepts/rejects. Taste signal from round 1: cut the bleak, keep inspiration/delight. PD rule: pre-1931 publications (haiku via Chamberlain 1902 et al.; no Blyth, no Hass, no Coleman Barks). |
