...
| Today block in About (nudge second home) | v2.33.0 | 2026-08-01 | **Real evidence (2026-07-28, ahead of due date):** yes, definitely reads it — visits About regularly to check nudge content and statistics together. Morning nudge alone "never fully covers it" — it's fast, and the moment it appears is a transition state (mind already moving to tasks right after), so it doesn't get fully absorbed in the moment. About is where the nudge's content actually lands. Points toward **kept**, not removal — one of the strongest pieces of evidence gathered so far for any surface in this table. |
