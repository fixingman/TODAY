...
| Daily brief (✦ → nudge + poem) | v2.29.0 | 2026-07-30 | **Correction (2026-07-28):** the 2026-07-21 pre-reg note ("nice / stressed to read it all / reflective / sharable") was misattributed here — it was actually about the poem splash coda (moved to that row below). **Real evidence for this surface (2026-07-28):** Can rarely clicks the ✦ button itself — a blinking icon reads as "there's an update behind it," not as its own draw. He opens About every day regardless, which surfaces the same underlying content (Today block, Noticed) independent of ✦. Live signal that the *entry point*, not the content, may be what's not landing — watch how this interacts with the Aug 1 Today-block verdict below before concluding either way. |
