...
|---|---:|---:|
| Runtime shell, decoded | 1084.3 KB | 1200.0 KB |
| Runtime shell, Brotli q5 | 312.4 KB | 350.0 KB |
...
| Cold LCP | 9712 ms | 9768 ms | 10500 ms |
| Cold CLS | 0.020 | 0.020 | 0.1 |
| Cold total blocking time | 0 ms | 11 ms | 200 ms |
| TODAY interactive, cold | 6031 ms | 6071 ms | 7000 ms |
| Splash dismissed, cold | 17939 ms | 17971 ms | 19000 ms |
| TODAY interactive, warm | 87 ms | 90 ms | 500 ms |
| Add-task response | 13 ms | 15 ms | 100 ms |
| Enter-focus response | 53 ms | 169 ms | 300 ms |
...
| cold.lcp | 9768 ms | 2500 ms | Above target |
| cold.cls | 0.020 | 0.1 | Pass |

Largest decoded runtime files:

| File | Decoded | Brotli q5 |
|---|---:|---:|
| `index.html` | 206.8 KB | 62.8 KB |
| `assets/dropbox.js` | 125.8 KB | 31.6 KB |
| `assets/focus.js` | 81.7 KB | 21.8 KB |
| `assets/insights.js` | 70.0 KB | 20.6 KB |
| `assets/poems.js` | 50.9 KB | 15.9 KB |
| `assets/about.js` | 42.3 KB | 12.4 KB |
