...
|---|---:|---:|
| Runtime shell, decoded | 1100.4 KB | 1200.0 KB |
| Runtime shell, Brotli q5 | 316.2 KB | 350.0 KB |
| `index.html`, Brotli q5 | 62.8 KB | 70.0 KB |
| Self-hosted fonts | 6 / 91.2 KB | 100.0 KB |
| Eager classic scripts | 37 | 37 (must not increase) |

| Timing | Median | Worst | Gate |
|---|---:|---:|---:|
| Cold TTFB | 3 ms | 10 ms | 1000 ms |
| Cold FCP | 1192 ms | 1204 ms | 1800 ms |
| Cold LCP | 9512 ms | 9752 ms | 10500 ms |
| Cold CLS | 0.010 | 0.010 | 0.1 |
| Cold total blocking time | 31 ms | 73 ms | 200 ms |
| TODAY interactive, cold | 6206 ms | 6365 ms | 7000 ms |
| Splash dismissed, cold | 16461 ms | 16714 ms | 19000 ms |
| TODAY interactive, warm | 210 ms | 243 ms | 500 ms |
| Add-task response | 9 ms | 20 ms | 100 ms |
| Enter-focus response | 74 ms | 277 ms | 300 ms |
...
|---|---:|---:|---|
| cold.fcp | 1204 ms | 1800 ms | Pass |
| cold.lcp | 9752 ms | 2500 ms | Above target |
