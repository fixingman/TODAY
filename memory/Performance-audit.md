...
|---|---:|---:|
| Runtime shell, decoded | 1116.1 KB | 1200.0 KB |
| Runtime shell, Brotli q5 | 320.6 KB | 350.0 KB |
...
|---|---:|---:|---:|
| Cold TTFB | 1 ms | 3 ms | 1000 ms |
| Cold FCP | 1188 ms | 1192 ms | 1800 ms |
| Cold LCP | 9460 ms | 9544 ms | 10500 ms |
| Cold CLS | 0.010 | 0.010 | 0.1 |
| Cold total blocking time | 0 ms | 0 ms | 200 ms |
| TODAY interactive, cold | 6178 ms | 6179 ms | 7000 ms |
| Splash dismissed, cold | 16369 ms | 16436 ms | 23000 ms |
| TODAY interactive, warm | 78 ms | 82 ms | 500 ms |
| Add-task response | 3 ms | 10 ms | 100 ms |
| Enter-focus response | 50 ms | 146 ms | 300 ms |
...
|---|---:|---:|---|
| cold.fcp | 1192 ms | 1800 ms | Pass |
| cold.lcp | 9544 ms | 2500 ms | Above target |
| cold.cls | 0.010 | 0.1 | Pass |

Largest decoded runtime files:

| File | Decoded | Brotli q5 |
|---|---:|---:|
| `index.html` | 210.4 KB | 63.4 KB |
| `assets/dropbox.js` | 127.4 KB | 32.1 KB |
