...
|---|---:|---:|
| Runtime shell, decoded | 1114.4 KB | 1200.0 KB |
| Runtime shell, Brotli q5 | 320.0 KB | 350.0 KB |
| `index.html`, Brotli q5 | 63.4 KB | 70.0 KB |
| Self-hosted fonts | 6 / 91.2 KB | 100.0 KB |
| Eager classic scripts | 37 | 37 (must not increase) |

| Timing | Median | Worst | Gate |
|---|---:|---:|---:|
| Cold TTFB | 1 ms | 2 ms | 1000 ms |
| Cold FCP | 1188 ms | 1200 ms | 1800 ms |
| Cold LCP | 9912 ms | 9976 ms | 10500 ms |
| Cold CLS | 0.030 | 0.030 | 0.1 |
| Cold total blocking time | 0 ms | 0 ms | 200 ms |
| TODAY interactive, cold | 6172 ms | 6175 ms | 7000 ms |
| Splash dismissed, cold | 17948 ms | 17976 ms | 23000 ms |
| TODAY interactive, warm | 70 ms | 74 ms | 500 ms |
| Add-task response | 9 ms | 29 ms | 100 ms |
| Enter-focus response | 100 ms | 164 ms | 300 ms |
...
|---|---:|---:|---|
| cold.fcp | 1200 ms | 1800 ms | Pass |
| cold.lcp | 9976 ms | 2500 ms | Above target |
| cold.cls | 0.030 | 0.1 | Pass |

Largest decoded runtime files:

| File | Decoded | Brotli q5 |
|---|---:|---:|
| `index.html` | 210.3 KB | 63.4 KB |
| `assets/dropbox.js` | 126.7 KB | 31.9 KB |
